...
public class ExtendedPropertiesReplacer implements ReplaceSource {
    ...
    public ExtendedPropertiesReplacer(final Function<String, String> valueProvider, final boolean failOnMissingKey) {
        this.valueProvider = valueProvider;
        this.failOnMissingKey = failOnMissingKey;
    }

    public ExtendedPropertiesReplacer(final Function<String, String> valueProvider) {
    ...
    private String getValue(final String name) {
        final Object v = this.valueProvider.apply(name);
        if (v == null) {
            return null;
        } else {
            return v.toString();
